 ...
 *
 * @see javax.persistence.EntityManager#setProperty
...
public interface SpecHints {
	/**
	 * Hint providing a {@link javax.persistence.EntityGraph} which should be
