...
public interface JpaCallbackSource {
	 ...
	 * @return the name of the JPA callback method defined for the associated {@linkplain javax.persistence.Entity entity} or {@linkplain javax.persistence.MappedSuperclass
	...
	/**
	 * @return the name of the instantiated container where the JPA callbacks for the associated {@linkplain javax.persistence.Entity entity} or
	 *         {@linkplain javax.persistence.MappedSuperclass mapped superclass} are defined. This can be either the entity/mapped superclass itself or an
	 *         {@linkplain javax.persistence.EntityListeners entity listener}.
	 */
	String getName();
