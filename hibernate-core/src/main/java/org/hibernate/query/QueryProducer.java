 ...
 * {@link javax.persistence.EntityManager}. They are declared here to allow reuse by
...
public interface QueryProducer {
	 ...
	 * {@link javax.persistence.EntityManager#createQuery(String)}.
	 *
	 ...
	 * named {@link javax.persistence.NamedQuery}
	 *
	...
	/**
	 * Create a {@link SelectionQuery} instance for the
	 * named {@link javax.persistence.NamedQuery} with the expected
	 * result-type
	 *
	 * @throws IllegalSelectQueryException if the given HQL query is a select query
	 * @throws UnknownNamedQueryException if no query has been defined with the given name
	 ...
	 * {@linkplain  javax.persistence.NamedQuery HQL}) or
	 * {@linkplain  javax.persistence.NamedNativeQuery native-SQL}.
	 *
